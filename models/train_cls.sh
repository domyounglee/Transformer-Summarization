...
MODEL_DIR=/root/workspace/summarization_tf1.14/models/CLS_16_summ_512_128_lr0.15_wrm8k_rmlen2048_$PARAM_SET
VOCAB_FILE=$DATA_DIR/vocab_train.txt
...
python transformer_main_cls.py --data_dir=$DATA_DIR --model_dir=$MODEL_DIR \
    --vocab_file=$VOCAB_FILE --param_set=$PARAM_SET \
    --train_steps=40000 \
    --steps_between_evals=20000 \
    --batch_size=16384 \
    --num_gpus=4  
