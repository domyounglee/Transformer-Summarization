...
def translate_file(
  ...
  def input_fn():
    ...
    ds = ds.padded_batch(batch_size, [512],drop_remainder=True)#define the sequence length 
...
def main(unused_argv):
  from official.transformer import transformer_main_cls_decode as transformer_main 
