...
CLS2= "CLS2"
CLS_ID2 = 5
RESERVED_TOKENS = [PAD, EOS,CLS, PAD2, EOS2,CLS2]

"""
RESERVED_TOKENS = [PAD, EOS,CLS, END]
######
...
class Subtokenizer(object):
  ...
  def _subtoken_ids_to_tokens(self, subtokens):
    ...
    subtkns=[ self.subtoken_list[s] for s in subtokens if s < len(self.subtoken_list) ]

    escaped_tokens = "".join(subtkns)
