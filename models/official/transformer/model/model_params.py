...
BASE_PARAMS = defaultdict(
    ...
    default_batch_size_tpu=32781,
    max_length=2048,  # Maximum number of tokens per example.
    max_input_length=512, #this must be same as the max_length 
    max_output_length=128,

    # Model params
    initializer_gain=1.0,  # Used in trainable variable initialization.
    vocab_size=32781,  # Number of tokens defined in the vocabulary file.
    ...
    allow_ffn_pad=True,
    block_trigram=True,
    #vocab_path="/root/workspace/summarization_tf1.14/t2t_data/vocab.summarize_cnn_dailymail32k.32768.subwords",
)
