...
python translate_withpad.py --model_dir=$MODEL_DIR --vocab_file=$DECODE_VOCAB_FILE \
    --param_set=$PARAM_SET --file=$DATA_DIR/test_article01.txt  --file_out=$DATA_DIR/_test_output_encode512_decode128_alpha08_beam5_lr015_rm01.txt
